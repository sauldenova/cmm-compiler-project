...
build: cmmFront ## Compiles all the files for the executable

clean: ## Cleans the directory from the intermediate files
	-rm cmmFront lex.yy.c cmm.tab.c cmm.tab.h
...
cmmFront: lex.yy.c cmm.tab.c
	$(C) $(C_FLAGS) $(C_DEBUG_FLAGS) -o cmmFront lex.yy.c cmm.tab.c cmm.c cmm_types.c
